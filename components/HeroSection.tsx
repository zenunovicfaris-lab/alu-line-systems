    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h1
              className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.0] tracking-[-0.02em]"
              style={{ textShadow: "0 2px 8px rgba(0,0,0,0.7), 0 1px 3px rgba(0,0,0,0.9)" }}
            >
              <span className="block text-white/95 mb-2">Aluminijum koji</span>
              <span className="block text-white">
                definiše{" "}
                <span style={{ color: "#5a9fd4" }}>stil.</span>
              </span>
            </h1>
          </motion.div>
