  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top right, rgba(20,60,95,0.25) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-600 text-[10px] font-semibold uppercase tracking-widest mb-0.5">
                  Telefon
                </p>
              ...
              <ArrowRight
                size={15}
                className="text-white/20 group-hover:text-alu-blue transition-colors duration-200"
              />
            </a>
            ...
            <div className="flex items-center gap-4 pt-2">
              <span className="text-[11px] text-white/25 tracking-widest uppercase font-medium">
                Pratite nas
              </span>
          ...
          <motion.div
            ...
            style={{
              minHeight: "440px",
              border: "1px solid rgba(20,60,95,0.35)",
            }}
          >
            <iframe
        ...
        >
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center gap-1">
              ...
              <span className="text-[11px] text-white/30 tracking-wide uppercase font-medium">
                {s.label}
              </span>
            </div>
          ))}
